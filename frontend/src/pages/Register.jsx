  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 8, pb: 6 }}>
      <Paper sx={{ p: 4, borderRadius: 4 }}>
        <Typography variant="h4" mb={3} align="center" sx={{ fontWeight: 800 }}>Register</Typography>
        ...
        <Box component="form" onSubmit={submit}>
          ...
          <Button type="submit" variant="contained" fullWidth sx={{ mt: 2, py: 1.5, fontSize: 16 }}>Register</Button>
